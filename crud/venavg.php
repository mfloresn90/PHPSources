...
include "conecta.php"; // llamamos a la conexión al servidor y la base de datos
 ...
 $consulta="select oficina_rep, avg(ventas)venta FROM repventas GROUP BY oficina_rep;";
 $resultado=mysql_query($consulta, $link);
 
 if ($row = mysql_fetch_array($resultado)){ 
    echo "<table border = '1'> \n"; 
    echo "<tr><td>oficina_rep</td><td>avg(ventas)</td></tr>\n"; 
    do { 
       echo "<tr><td>".$row["oficina_rep"]."</td><td>".$row["venta"]."</td></tr> \n"; 
