...
<div align="center">
  <p><img src="imagenes/uaem.jpg" alt="u" width="1018" height="131" /><img src="imagenes/line.jpg" alt="li" width="1018" height="31" /><img src="imagenes/arco.jpg" alt="ar" width="1018" height="113" /><img src="imagenes/line.jpg" alt="li" width="1018" height="31" /><img src="imagenes/producto.png" alt="al" width="1018" height="80" /></p>
</div>
<form id="form1" name="form1" method="post" action="i_producto.php">
  <p align="center">
    <label for="nocta"><span class="Estilo2"><br />
    </span><span class="Estilo4">IdProducto</span></label>
    <span class="Estilo4">
  ...
  <p align="center" class="Estilo4">
    <label for="ApellidoMaterno">Descripción</label>
  <input type="text" name="des" id="des">
  </p>
  <p align="center" class="Estilo4">
    <label for="ApellidoMaterno2">Precio</label>
    <input type="text" name="pre" id="pre" />
  </p>
  <p align="center" class="Estilo4">Existencias
